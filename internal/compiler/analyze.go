...
import (
	...
	analyzer "github.com/thedemons/sqlc/internal/analysis"
	...
	"github.com/thedemons/sqlc/internal/sql/named"
	"github.com/thedemons/sqlc/internal/sql/rewrite"
	"github.com/thedemons/sqlc/internal/sql/validate"
)
